	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			<li class="nav-item active">
				<a class="nav-link" href="#">Ну так-то да, ты АДМИН)</a>
			</li>
			<li class="nav-item active">
		...
		foreach ($on_screen as $key=>$value) : ?> <!-- вывод книг -->
						<div class="col-sm-3">
							<div class="works-img tilt">
                                <a href="change_bookpadge.php?id_book=<?php echo $value['id_book'];?>"><img src="../<?php echo $value['images'];?>" alt=""></a><!--переход на страницу с книгой (адрессная строка)-->
